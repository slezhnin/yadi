...
public class SimpleServiceSupplier2<T> implements Supplier<T> {

    private final ServiceLocator serviceLocator;
    private final Supplier<T> instanceSupplier;
    private final MethodDependency[] methodDependencies;

    public SimpleServiceSupplier2(ServiceLocator serviceLocator, Supplier<T> instanceSupplier, MethodDependency[] methodDependencies) {
